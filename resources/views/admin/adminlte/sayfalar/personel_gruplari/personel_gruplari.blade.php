            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <div class="breadcrumb float-sm-right">
                        <a @if(@kullanicininYetkileri()["personel_gruplari"]["ekle"] == "on") class="btn  ml-2 btn-outline-info" href="{{route("admin.personel_gruplari_ekle.get")}}" @else href="#" title="YETKİNİZ YOK" class="btn  ml-2 btn-outline-info not-allowed" @endif><i class="fa fa-plus"></i> {{config("const.personel_grubu")}} {{config("const.ekle")}}</a>
                    </div>
                </div>
            </div>
        </div><!-- /.container-fluid -->
